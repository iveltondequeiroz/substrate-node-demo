...
use substrate_node_template_runtime::{self, GenesisConfig, opaque::Block, ClientWithApi};
...
native_executor_instance!(
	...
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/substrate_node_template_runtime.compact.wasm")
);
